...
str2dataset = {"bertv1":BertV1Dataset ,"bert": BertDataset, "lm": LmDataset, "mlm": MlmDataset,
               "bilm": BilmDataset, "albert": AlbertDataset, "seq2seq": Seq2seqDataset,
               "t5": T5Dataset, "cls": ClsDataset, "prefixlm": PrefixlmDataset}
str2dataloader = {"bertv1": BertV1DataLoader, "bert": BertDataLoader, "lm": LmDataLoader, "mlm": MlmDataLoader,
...
__all__ = ["CharTokenizer", "SpaceTokenizer", "BertTokenizer", "str2tokenizer",
           "BertV1Dataset", "BertDataset", "LmDataset", "MlmDataset", "BilmDataset",
           "AlbertDataset", "Seq2seqDataset", "T5Dataset", "ClsDataset",
           "PrefixlmDataset", "str2dataset",
           "BertV1DataLoader", "BertDataLoader", "LmDataLoader", "MlmDataLoader", "BilmDataLoader",
